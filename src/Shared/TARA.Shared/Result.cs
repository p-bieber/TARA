...
public class Result<TValue> : Result
{
    ...
    protected internal Result(TValue? value, bool isSuccess, AppError error)
...
public class Result
{
    protected internal Result(bool isSuccess, AppError error)
    {
    ...
    public static Result<TValue> Create<TValue>(TValue? value) => value is not null ? Success(value) : Failure<TValue>(AppError.NullValue);
}
